...
public class Main {
	...
	public static void serializeMap(String fileName, Map<Project, ArrayList<Employee>> map) throws IOException {
        ...
        out.writeObject(map);
        out.flush();
        System.out.println(" serialized map of Successfully");
    }
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        serializeMap("C:\\Lava\\ser.txt", map1);

       Map<Project, ArrayList<Employee>> deserializedMap1 = deserializeMap("C:\\Lava\\ser.txt");
